...
import { Home, LogOut, LogOutIcon, Package, PanelBottom, Settings2, ShoppingBag, Users } from "lucide-react";
    ...
    return (
        <div className="flex w-full flex-col bg-muted/40">
            ...
            <div className="sm:hidden flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
                <header className="sticky top-0 z-30 flex h-14 items-center px-4 border bg-background gap-4
